...
public class CompanyTestSamples {
    ...
    public static Company getCompanySample1() {
        return new Company().id(1L).companyName("companyName1");
    }

    public static Company getCompanySample2() {
        return new Company().id(2L).companyName("companyName2");
    }

    public static Company getCompanyRandomSampleGenerator() {
        return new Company().id(longCount.incrementAndGet()).companyName(UUID.randomUUID().toString());
    }
}
