...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESERVEDITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESERVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESERVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESERVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESERVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESERVEDITEM actions', async () => {
      const expectedActions = [
        {
