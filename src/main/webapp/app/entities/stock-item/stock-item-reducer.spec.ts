...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOCKITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKITEM actions', async () => {
      const expectedActions = [
        {
