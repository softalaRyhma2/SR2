...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKITEMTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOCKITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKITEMTYPE actions', async () => {
      const expectedActions = [
        {
