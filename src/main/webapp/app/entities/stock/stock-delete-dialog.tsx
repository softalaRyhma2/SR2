...
export const StockDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/stock' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sr2App.stock.delete.question">
        <Translate contentKey="sr2App.stock.delete.question" interpolate={{ id: stockEntity.id }}>
