...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './stock-item-type-company.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKITEMTYPECOMPANY_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOCKITEMTYPECOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKITEMTYPECOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKITEMTYPECOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKITEMTYPECOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKITEMTYPECOMPANY actions', async () => {
      const expectedActions = [
        {
