...
import com.softala.sr2.service.MailService;
...
import com.softala.sr2.web.rest.errors.EmailAlreadyUsedException;
import com.softala.sr2.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.softala.sr2.domain.User} entity, and needs
...
public class UserResource {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAnyAuthority('" + AuthoritiesConstants.ADMIN + "', '" + AuthoritiesConstants.RECSER + "')")
